...
const onSubmit = () => {
  ...
  //   icon.value = result.value[0].name;
  // }
  ...
  <footer ref="footerRef">
    <form class="chat-form" @submit.prevent="onSubmit">
      <div class="icon-input-group">
        <button
          class="icon-btn icon-select-button"
          :class="{ open: chatEmotesOpen }"
          @click.capture="toggleChatEmotesOpen()"
        >
        ...
        <div class="icon-select-group" :class="{ open: chatEmotesOpen }">
          <TransitionGroup>
            ...
            >
              ...
              />
              <ImgIcon :name="item.name" :src="item.src" :color="item.color" />
            </label>
          </TransitionGroup>
        </div>
      </div>
